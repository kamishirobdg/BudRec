...
export default function MapViewer() {
  ...
  // Ensure each ceconst SECTORS_WITH_TILE_TAG = useMemo(() => {
    ...
    // Expansion tiles are sparse footprints (MIDDLE=tri3, LITTLE/SCOUT=single).
    // Keep sparse structure so the board builder can respect footprint, but inject tile tag into each cell.
