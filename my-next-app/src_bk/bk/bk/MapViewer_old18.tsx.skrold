          ...
          <div style={{ marginTop: 8, border: "1px solid #eee", borderRadius: 10, padding: 10 }}>
            ...
            {!scoreResult ? (
              ...
              <>
                ...
                <div style={{ overflow: "auto", border: "1px solid #f0f0f0", borderRadius: 10 }}>
                  <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
                    <thead>
                      <tr style={{ background: "#fafafa" }}>
                        ...
                        <th style={{ textAlign: "left", padding: 8, borderBottom: "1px solid #eee" }}>Base tiles (non-zero)</th>
                        <th style={{ textAlign: "left", padding: 8, borderBottom: "1px solid #eee" }}>GAIA tiles</th>
                      </tr>
                    </thead>
                    <tbody>
