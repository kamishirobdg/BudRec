...
import type { SectorTileLf } from "./sectorTypes";
...
export const EXPANSION_MIDDLE: readonly SectorTileMiddle[] = [
  {
    id: "11a",
    cells: {
...
export const EXPANSION_LITTLE: readonly SectorTileLittle[] = [
  {
    id: "19",
    radius: 0,
    cells: {
...
export const EXPANSION_SCOUT: readonly SectorTileScout[] = [
